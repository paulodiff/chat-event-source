...
(function() {
    ...
    function SocketConnection(connection, connectCallback) {
        ...
        if (connection.socketPath){
            connection.socketOptions['path'] = connection.socketPath;
            console.log(connection.socketOptions);
        }

        console.log('SocketConnection: parameters:', parameters);
        console.log('SocketConnection: socketURL', connection.socketURL);
        console.log('SocketConnection: socketPath', connection.socketPath);
        console.log('SocketConnection: socketOptions', connection.socketOptions);
        ...
        this.getLocalConfig = function(remoteSdp, remoteUserId, userPreferences) {
            ...
            return {
                ...
                onDataChannelMessage: function(message) {
                    ...
                    //console.log('##### onDataChannelMessage1');
                    //console.log(message);
