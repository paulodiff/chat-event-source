...
module.exports = exports = function(app, socketCallback) {
    ...
    console.log('Signaling-Server.js .start');
...
/*
server   var io = require('socket.io')(server, {'transports': ['websocket', 'polling']});
client    var io = io( serverUri, {'transports': ['websocket', 'polling']});
*/
/*
...
*/
    ...
    io.sockets.on('connection', function(socket) {
        ...
        console.log('Signaling-Server.js .on connection');
        ...
        socket.on('extra-data-updated', function(extra) {
            try {
                ...
                console.log('Errore extra-data-updated...',e);
            }
        });
        ...
        socket.on('become-a-public-moderator', function() {
            try {
                ...
                console.log('Errore become-a-public-moderator...',e);
            }
        });
        ...
        socket.on('set-password', function(password) {
            try {
                ...
                console.log('Errore set-password...',e);
            }
        });
        ...
        socket.on('disconnect-with', function(remoteUserId, callback) {
            try {
                ...
                console.log('Errore disconnect-with...',e);
            }
        });
        ...
        function onMessageCallback(message) {
            try {
                ...
                console.log('Errore onMessageCallback...',e);
            }
        }
        ...
        socket.on(socketMessageEvent, function(message, callback) {
            ...
            try {
                ...
                console.log('Errore socketMessageEvent...',e);
            }
        });
        ...
        socket.on('disconnect', function() {
            try {
                ...
                console.log('Errore disconnect...',e);
            }
